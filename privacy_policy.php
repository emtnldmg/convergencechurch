            ...
            <section class="home" id="home">
                ...
                <div class="church__container container grid">
                    <div class="church__data">
                        <h1 class="church__data-title">  <b>PRIVACY POLICY</b></h1>
            ...
            <section class="about section" id="about">
                <div class="about__container container grid">
                    ...
                    <?php
                            ...
                            $query = "SELECT * FROM sections where sname = 'PrivacyPolicySection'";
                 ...
                 $query = "SELECT * FROM photos where pname ='PrivacyPolicySection' ";
                 $query_run = mysqli_query($connection,$query);
